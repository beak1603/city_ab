(function () {
  ...
  const guides = {
    ...
    "game-start": {
      ...
      scenes: [
        ...
        {
          title: "3-2. 토큰상점",
          description: "- 획득한 토큰으로 토큰상점에서 필요한 아이템을 구매할 수 있습니다\n- 토큰상점은 맵 중앙에 하나 존재합니다\n- 토큰상점 지역으로 들어오는 순간 HP가 고정되며, 피해를 받지 않는 대신 허기가 빠르게 소모됩니다(상점 존버 방지)",
          villager: "./token-shop-supplied-20260912-v5.png",
        },
        {
          title: "4. 부활시스템",
  ...
  function ensureGameGoal() {
    ...
    stats.setAttribute("aria-label", "45개의 능력 25분의 시간 1명의 생존자");

    [
      { number: "45", label: "개의 능력" },
      { number: "25", label: "분의 시간" },
