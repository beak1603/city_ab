  ...
  function createScene(scene, index) {
    ...
    if (scene.diagram === "token-stations") {
      ...
      diagram.innerHTML = [
        ...
        "</filter>",
        "<mask id='token-station-diamond-mask' maskUnits='userSpaceOnUse' x='0' y='0' width='1448' height='1080'>",
        "<rect x='0' y='0' width='1448' height='1080' fill='#000'/>",
        "<g class='token-station__nodes'>",
        "<path class='token-station__node token-station__node--active' data-x='724' data-y='116' transform='translate(724 116)' d='M0 -68 C7 -24 24 -7 68 0 C24 7 7 24 0 68 C-7 24 -24 7 -68 0 C-24 -7 -7 -24 0 -68 Z' fill='#fff' filter='url(#token-station-mask-soften)'/>",
        "<path class='token-station__node' data-x='1028' data-y='244' transform='translate(1028 244)' d='M0 -68 C7 -24 24 -7 68 0 C24 7 7 24 0 68 C-7 24 -24 7 -68 0 C-24 -7 -7 -24 0 -68 Z' fill='#fff' filter='url(#token-station-mask-soften)'/>",
        "<path class='token-station__node' data-x='1144' data-y='522' transform='translate(1144 522)' d='M0 -68 C7 -24 24 -7 68 0 C24 7 7 24 0 68 C-7 24 -24 7 -68 0 C-24 -7 -7 -24 0 -68 Z' fill='#fff' filter='url(#token-station-mask-soften)'/>",
        "<path class='token-station__node token-station__node--active' data-x='1028' data-y='792' transform='translate(1028 792)' d='M0 -68 C7 -24 24 -7 68 0 C24 7 7 24 0 68 C-7 24 -24 7 -68 0 C-24 -7 -7 -24 0 -68 Z' fill='#fff' filter='url(#token-station-mask-soften)'/>",
        "<path class='token-station__node' data-x='724' data-y='912' transform='translate(724 912)' d='M0 -68 C7 -24 24 -7 68 0 C24 7 7 24 0 68 C-7 24 -24 7 -68 0 C-24 -7 -7 -24 0 -68 Z' fill='#fff' filter='url(#token-station-mask-soften)'/>",
        "<path class='token-station__node' data-x='419' data-y='792' transform='translate(419 792)' d='M0 -68 C7 -24 24 -7 68 0 C24 7 7 24 0 68 C-7 24 -24 7 -68 0 C-24 -7 -7 -24 0 -68 Z' fill='#fff' filter='url(#token-station-mask-soften)'/>",
        "<path class='token-station__node' data-x='303' data-y='522' transform='translate(303 522)' d='M0 -68 C7 -24 24 -7 68 0 C24 7 7 24 0 68 C-7 24 -24 7 -68 0 C-24 -7 -7 -24 0 -68 Z' fill='#fff' filter='url(#token-station-mask-soften)'/>",
        "<path class='token-station__node' data-x='419' data-y='244' transform='translate(419 244)' d='M0 -68 C7 -24 24 -7 68 0 C24 7 7 24 0 68 C-7 24 -24 7 -68 0 C-24 -7 -7 -24 0 -68 Z' fill='#fff' filter='url(#token-station-mask-soften)'/>",
        "</g>",
        "</mask>",
        "</defs>",
